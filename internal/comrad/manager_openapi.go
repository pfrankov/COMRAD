...
func openAPISchemas() map[string]any {
	return map[string]any{
		...
		"Artifact":                      object(map[string]any{"artifactId": stringSchema(), "id": stringSchema(), "kind": stringSchema(), "name": stringSchema(), "sha256": stringSchema(), "sizeBytes": integerSchema(), "createdAt": dateTimeSchema()}),
