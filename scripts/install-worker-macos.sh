...
P2P_PORT="${COMRAD_WORKER_P2P_PORT:-6881}"
P2P_MAX_UPLOADS="${COMRAD_WORKER_P2P_MAX_UPLOADS:-8}"
P2P_DOWNLOAD_TIMEOUT_SECONDS="${COMRAD_WORKER_P2P_DOWNLOAD_TIMEOUT_SECONDS:-120}"
...
<dict>
  ...
  <dict>
    ...
    <key>COMRAD_WORKER_P2P_PORT</key><string>$P2P_PORT</string>
    <key>COMRAD_WORKER_P2P_MAX_UPLOADS</key><string>$P2P_MAX_UPLOADS</string>
    <key>COMRAD_WORKER_P2P_DOWNLOAD_TIMEOUT_SECONDS</key><string>$P2P_DOWNLOAD_TIMEOUT_SECONDS</string>
